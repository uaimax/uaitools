...
2. No menu lateral, clique em **"bau_mental"** (ícone de microfone)
3. Ou acesse diretamente: `http://localhost:5173/admin/bau-mental`
...
2. **Verificar Celery:**
   ```bash
   # Deve mostrar tasks do bau_mental
...
3. **Testar API:**
   ...
   curl -H "Authorization: Bearer <token>" \
        ...
        http://localhost:8001/api/v1/bau-mental/boxes/
   ```
...
**Solução:**
1. Verificar se a rota está em `/admin/bau-mental`
...
- `@docs/bau-mental_ARCHITECTURE.md` - Arquitetura detalhada
- `@backend/apps/bau_mental/ANALYSIS.md` - Análise do módulo
