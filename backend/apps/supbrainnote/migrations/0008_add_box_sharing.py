...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('supbrainnote', '0007_add_note_tracking'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shares', to='supbrainnote.box', verbose_name='Caixinha')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('box', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pending_invites', to='supbrainnote.box', verbose_name='Caixinha')),
